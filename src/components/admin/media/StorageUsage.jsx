...
export default function StorageUsage({ mediaFiles }) {
  ...
  return (
    <div className="col-span-2 row-start-4 row-end-5 flex flex-col gap-4 py-3 px-4 rounded-lg shadow-md bg-white max-sm:col-span-full max-sm:row-start-5 max-sm:row-end-6">
      <SectionHeader
        title="Storage Usage"
