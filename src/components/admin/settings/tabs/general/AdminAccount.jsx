...
export default function AdminAccount() {
  return (
    <div className="col-start-1 col-end-3 row-start-2 row-end-3 flex flex-col py-3 px-4 rounded-lg shadow-md bg-white max-md:col-span-full max-md:row-start-4 max-md:row-end-5">
      <SectionHeader
        title="Admin Account"
